...
- Create Angular project with ng: `ng new custom-b2e-project.client --defaults --skip-install --skip-git `.
...
- Create project file (`custom-b2e-project.client.esproj`).
- Create `launch.json` to enable debugging.
- Create `nuget.config` to specify location of the JavaScript Project System SDK (which is used in the first line in `custom-b2e-project.client.esproj`).
